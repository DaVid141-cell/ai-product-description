            ...
            <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                    ...
                    <form className="w-full">
                        ...
                        <button
                            className="mt-1 w-full bg-[#4a90e2] px-6 py-3 text-sm font-bold tracking-wide text-white uppercase transition-none hover:bg-[#4a90e2] sm:mt-0 sm:w-auto sm:shrink-0"
                        >
                            Sign Up
                        </button>
                        </div>
                    ...
                    <ul className="mt-6 space-y-4 text-sm">
                        ...
                        <li>
                        <a href="#" className="text-white transition hover:opacity-75"> Generated Ai </a>
                        </li>
                    </ul>
                    </div>
                    ...
                    <div className="col-span-2 sm:col-span-1">
                    <p className="font-medium text-black">Downloads</p>
                ...
                <div className="sm:flex sm:justify-between">
                    <p className="text-xs text-black">&copy; 2022. Company Name. All rights reserved.</p>
